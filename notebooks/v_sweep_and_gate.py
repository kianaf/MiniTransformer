"""V-sweep and predictability-gate analysis for the MiniTransformer permutation
...
(A) computes per-target test-set MSE for the model and two baselines
    ...
    features); flags which targets *pass the predictability gate*, i.e.
...
Outputs (under notebooks/results/v_sweep_and_gate/):
...
OUT_DIR = "notebooks/results/v_sweep_and_gate"
...
def main():
    ...
    # 7. Plots: 3 panels (mean p, rejection rate at 0.05, KS distance) x V
